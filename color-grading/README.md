...
python3 tools/gen_look_dctls.py        # regenerates resolve/dctl/looks/ from the recipes
python3 tools/dctl_test/run_dctl_tests.py   # compiles every DCTL with gcc and checks it against the maths
```
